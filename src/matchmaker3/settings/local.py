# Django settings for matchmaker3 project.
import os

EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'imugabi1@gmail.com'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'matchmaker3.sqlite3',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'o8-u2@#ywo78f%i67q!(+=do9!@@l2fdjj8am3(9#0ls6kpamx'
...
MIDDLEWARE_CLASSES = (
    ...
    'matchmaker3.middleware.CheckMembership',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'matchmaker3.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'matchmaker3.wsgi.application'
