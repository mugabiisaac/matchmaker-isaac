...
def points(request_user, matched_user):
    """
    Compare user and match user answers, track and assign points accordingly
    """
    ...
    print "out of %s questions, %s points were awarded out of %s points with a score of %s" % (total_questions, points_awarded, points_possible, percentage)
